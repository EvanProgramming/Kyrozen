...
class ProblemDiscoveryAgent(BaseAgent):
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "- Ask at most 2 follow-up questions total. Once you have enough information, stop asking and synthesize the Problem Brief.\n"
            "- The minimum information needed for a Problem Brief is: target_user, scenario, surface_problem, and current_solution.\n"
            "- If the user's message already provides these key details, do NOT ask follow-up questions; save the brief immediately.\n"
