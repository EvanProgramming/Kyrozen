...
export function LoginPage() {
  ...
  const handleGithubLogin = async () => {
    ...
    resetTimer.current = setTimeout(() => {
      ...
      setError('GitHub 登录尚未完成，请检查浏览器提示后重试。');
    }, 30_000);
    ...
    <div className="flex-1 flex items-center justify-center p-6 bg-paper">
      <div className="w-full max-w-sm panel p-8 text-center">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 rounded bg-ink text-surface hover:bg-ink-soft disabled:opacity-50 font-medium transition-colors mb-4"
        >
