            ...
            {tab === 'procurement' && (
              <>
                ...
                <div className="panel p-4 space-y-3">
                  ...
                  <div className="flex gap-2 flex-wrap"><button type="button" className="btn-secondary text-sm" disabled={hardwareBusy} onClick={() => void runHardware('list_ports')}>只读发现设备</button><button type="button" className="btn-secondary text-sm" disabled={hardwareBusy} onClick={() => void runHardware('compile')}>编译固件</button><button type="button" className="btn-secondary text-sm" disabled={hardwareBusy || !hardwarePort} onClick={() => void runHardware('upload')}>上传固件</button><button type="button" className="btn-secondary text-sm" disabled={hardwareBusy || !hardwarePort} onClick={() => void runHardware('monitor')}>串口观察</button><button type="button" className="btn-secondary text-sm" disabled={hardwareBusy} onClick={() => void runHardware('list_ports')}>拔插后重新发现</button></div>
