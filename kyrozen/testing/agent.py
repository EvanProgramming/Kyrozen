...
class TestingAgent(BaseAgent):
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "- Generate a final Validation Report with save_validation_report only after the required "
            "user validation is complete. For Phase 2, conclusion must be exactly one of: "
            "continue_release, release_after_fix, reduce_scope, stop_project.\n"
